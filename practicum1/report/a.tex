...
\lstinputlisting[float, firstline=71, lastline=79, label={lst:a:euclideanDistance}, caption={An implementation of the Euclidean distance.}]{../assignment1A.py}
~\\
...
\lstinputlisting[float, firstline=82, lastline=89, label={lst:a:pathLength}, caption={Compute the length of the polygonal path between consecutive points.}]{../assignment1A.py}
