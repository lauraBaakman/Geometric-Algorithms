#!/usr/bin/env python
print "		======================================================"
print "		  testing ConvexHull2 for degenerate situations"
print "		======================================================\n"
# H.Bekker@rug.nl
# In this program the convex hull algorithm in 2D is implemented.
# It is based on the algorithm given in "Computational geometry (M. de Berg, M van Kreveld, M. Overmars, O. Scharzkopf  )"
#Various sets of points may be generated by using generatePointsA() or generatePointsB() or #generatePointsC() or generatePointsD()
# The last two give degenerate sets of points
#Also filtered predicates are used, that is, when the uncertainty of a floating point result is high
#the same calculation is performed using rational numbers.
...
def generatePointsC():  #degenerate case, triangle
   p1=[50, 50]
   p2=[600, 679]
   p3=[221, 532]
   p4=[200, 300]
...
def generatePointsD():  #degenerate case, line
   p1=[50, 50]
   p2=[600, 679]
   points.append(p1)
   points.append(p2)
...
def display():
    ...
    if len(ch)>0:    
      glVertex2f (ch[len(ch)-1][0],ch[len(ch)-1][1])  # draw edge from last to first entry in ch
