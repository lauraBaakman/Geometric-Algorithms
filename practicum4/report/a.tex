...
\subsubsection*{Face}
	...
	\lstinputlisting[firstline=16, lastline=20, label={lst:a:face}, caption={The definition of the class \t{Face}.}]{../face.py}
...
\lstinputlisting[linerange={31-42}, label={lst:a:get_edges_inner_component}, caption={The method \t{get_edges_inner_component()} in the class \t{Face}.}]{../face.py}
...
\begin{figure}
	\centering
	\includegraphics[width=0.4\textwidth]{./img/a_outer_boundary}
