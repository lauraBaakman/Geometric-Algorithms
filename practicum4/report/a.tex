...
\subsubsection*{HalfEdge}
	...
	\todo[inline]{Edges zijn niet uniquely defined by hun origin en destination, i.e. de nerves van een voronoi diagram. __eq__ aanpassen óf hier uitleggen waarom het geen probleem is. Beter aanpassen!}
