...
\subsection*{The Algorithm}
	...
	\lstinputlisting[float, firstline=157, lastline=166, label={lst:a:polygonIntersectionAlgorithmFinalize}, caption={The method \t{_algorithm_finalize} in the class \t{ConvexPolygonIntersection}.}]{../convexPolygonIntersection.py}
