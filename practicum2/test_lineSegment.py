...
class TestLinesegmentIntersection(unittest.TestCase):
    ...
    def test_intersecting_linesegments(self):
        ...
        self.assertEqual(l1.intersect_line_segments(l2), intersection_point)
        self.assertEqual(l2.intersect_line_segments(l1), intersection_point)
    ...
    def test_non_intersecting_non_parallel_linesegments(self):
        ...
        self.assertIsNone(l1.intersect_line_segments(l2))
        self.assertIsNone(l2.intersect_line_segments(l1))
    ...
    def test_colinear_equal(self):
        ...
        l1 = LineSegment([[1.0, 1.0], [5.0, 1, 0]])
        self.assertIsNone(l1.intersect_line_segments(l1))
